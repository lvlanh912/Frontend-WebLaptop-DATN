        ...
        <Transition>
          <div class="" v-show="isOpenFilter">
            <div class="form-control border-0">
              <strong class="form-label">Trạng thái</strong>
              <select class="form-select" v-model="filterobj.active">
                <option value="" >Tất cả</option>
                <option :value="true">Mã giảm giá đã được kích hoạt</option>
                <option :value="false">Mã giảm giá không được kích hoạt</option>
              </select>
            </div>
            <div class="form-control border-0">
              <strong class="form-label d-block">Thời gian tạo mã</strong>
              <div class="d-flex justify-content-center align-content-center">

                <input @change="dateValidate" type="date" v-model="filterobj.createTimeStart">
                <span class="mx-2">đến</span>
                <input type="date" v-model="filterobj.createTimeEnd" @change="dateValidate">
              </div>
            </div>
