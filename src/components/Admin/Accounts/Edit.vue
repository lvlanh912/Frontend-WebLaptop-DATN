                            ...
                            <div class="px-4">
                                <div class="text-center px-0 border-0">
                                    <div class="card-img mx-auto rounded-circle">
                                        <img class="img-fluid" :src="image_profile" style="width: 200px;" alt="user image">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="px-4 d-flex flex-column justify-content-center align-content-center ">
                                ...
                                <select v-model="account_payload.roles">
                                    <option value="0" :selected="account_payload.roles==0">0 (vô hiệu hoá)</option>
                                    <option value="1" :selected="account_payload.roles==1">1 (người dùng bình thường)</option>
                                    <option value="2" :selected="account_payload.roles==2">2 (quản trị viên)</option>
                                </select>
                                <div class="form-group">
                                    <p class="mb-0  pt-2 text-darker">Tên người dùng</p>
                                    <input class="form-control" v-model="account_payload.username" type="text">
                                </div>
                                <p class="text-darker pt-2 mb-0">Địa chỉ email</p>
                                <input class="form-control" v-model="account_payload.email" type="text">
                                <p class="text-darker pt-2 mb-0">Số điện thoại</p>
                                <input class="form-control" v-model="account_payload.phone" type="text">
                                <p class="text-darker pt-2 mb-0">Giới tính</p>
                                <div class="d-flex">
                                    <div class=" form-check">
                                        <input class="form-check-input " type="radio" id="male" :value="true"  v-model="account_payload.sex" />
                                        <label for="male" class="me-2 form-check-label">Nam</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="female" :value="false"  v-model="account_payload.sex" />
